...
public class LunarDateView extends TextView implements OnClickListener, OnLongClickListener {
    private static final String TAG = "LunarDateView";
    ...
    public LunarDateView(Context context, AttributeSet attrs) {
        super(context, attrs);
