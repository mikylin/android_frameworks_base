/*
 * Copyright 2014 The KylinMod OpenSource Project
 *
...
public class Halo extends FrameLayout implements Ticker.TickerCallback {
    ...
    class HaloEffect extends HaloProperties {
        ...
        public void nap(long delay) {
            ...
            int haloCounterType = Settings.System.getIntForUser(mContext.getContentResolver(),
                    Settings.System.HALO_NOTIFY_COUNT, HALO_NOTIFY_BOTH, UserHandle.USER_CURRENT);
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (mState == State.DRAG) {
                ...
                if (y != getHaloContentY() && (!contentYAnimator.isRunning() || verticalGesture())) {
                    ...
                    int msgAnimation = Settings.System.getIntForUser(mContext.getContentResolver(), Settings.System.HALO_MSGBOX_ANIMATION, 2, UserHandle.USER_CURRENT);
    ...
    void tick(NotificationData.Entry entry, int delay, int duration, boolean alwaysFlip, boolean showContent, boolean flipContent) {
        ...
        mEffect.invalidate();
        if (mPingNewcomer && Settings.System.getIntForUser(mContext.getContentResolver(), Settings.System.HALO_UNLOCK_PING, 0, UserHandle.USER_CURRENT) == 0) return;
                ...
                if (entry.notification == notification) {
                    ...
                    if (mIsNotificationNew) {
                        ...
                        if (mState != State.FIRST_RUN) {
                            ...
                            boolean showMsgBox = Settings.System.getIntForUser(mContext.getContentResolver(), Settings.System.HALO_MSGBOX, 1, UserHandle.USER_CURRENT) == 1;
    ...
    public class ScreenReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if(intent.getAction().equals(Intent.ACTION_USER_PRESENT) &&
                    Settings.System.getIntForUser(resolver, Settings.System.HALO_ACTIVE, 0, UserHandle.USER_CURRENT) == 1 &&
                    Settings.System.getIntForUser(resolver, Settings.System.HALO_UNLOCK_PING, 0, UserHandle.USER_CURRENT) == 1 &&
                    ...
                    mHandler.postDelayed(new Runnable() {
                        public void run() {
                            ...
                            if (lastMsg > 0) {
                                ...
                                mEffect.nap(HaloEffect.NAP_DELAY + HaloEffect.WAKE_TIME * 2);
                                if (mHideTicker) mEffect.sleep(HaloEffect.SLEEP_DELAY + HaloEffect.WAKE_TIME * 2, HaloEffect.SLEEP_TIME, false);
                                boolean showMsgBox = Settings.System.getIntForUser(resolver, Settings.System.HALO_MSGBOX, 1, UserHandle.USER_CURRENT) == 1;
